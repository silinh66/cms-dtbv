    ...
    this.state = {
      ...
      column: [
        ...
        // },
        {
          ...
          filteredValue: null,
          onFilter: (value, record) => {
            return record.editor_name.indexOf(value) === 0;
          },
          width: 150,
          render: (value, item) => {
  ...
  _onRefreshData = () => {
    ...
    axios.get(`${apiUrl}/tenticker`).then((res) => {
      ...
      const sortData = dataSource.sort((b, a) => {
        if (a.confirm_audio_date === null) {
          return moment(0) - moment(b.confirm_audio_date);
        } else if (b.confirm_audio_date === null) {
          return moment(a.confirm_audio_date) - moment(0);
        } else {
          return moment(a.confirm_audio_date) - moment(b.confirm_audio_date);
        }
      });
