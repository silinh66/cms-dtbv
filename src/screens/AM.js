  ...
  _onRefreshData = () => {
    ...
    axios.get(`${apiUrl}/tenticker`).then((res) => {
      ...
      const sortData = dataSource.sort((b, a) => {
        if (a.confirm_content_date === null) {
          return moment(0) - moment(b.confirm_content_date);
        } else if (b.confirm_content_date === null) {
          return moment(a.confirm_content_date) - moment(0);
        } else {
          return (
            moment(a.confirm_content_date) - moment(b.confirm_content_date)
          );
        }
      });
