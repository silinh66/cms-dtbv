...
import SalaryCurrentPrivate from "./SalaryCurrentPrivate";
import SalaryOldPrivate from "./SalaryOldPrivate";
...
export default class SalaryPrivate extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  _renderTab = (type) => {
    switch (type) {
      case "salary_current":
        return (
          <SalaryCurrentPrivate data={this.props.data} ref={this.currentRef} />
        );
      // case "salary_old":
      //   return <SalaryOldPrivate ref={this.oldRef} />;
      default:
        return null;
    }
  };
