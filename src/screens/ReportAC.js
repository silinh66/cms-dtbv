...
import { formatNumber, monthFormat } from "../utils/common";
...
export default class ReportAC extends Component {
  constructor(props) {
    super(props);
    this.state = {
      month: null,
      ...
      column: [
        ...
        },
        {
          ...
          width: 70,
          defaultSortOrder: "ascend",
          sorter: (a, b) => a.count_audio - b.count_audio,
        },
        {
          title: "View",
        ...
        },
        {
          ...
          width: 70,
          defaultSortOrder: "ascend",
          sorter: (a, b) => a.views_per_audio - b.views_per_audio,
          render: (item, record) => {
            return <div>{formatNumber(item)}</div>;
          },
        },
  ...
  getDataReportCW = (monthYear) => {
    axios.get(`${apiUrl}/reportAC?monthYear=${monthYear}`).then((res) => {
      // console.log("res", res);
      this.setState({
      ...
      switch (index) {
        ...
        case 4:
          return {
            ...col,
            sortOrder: !isEmpty(sortedInfo)
              ? sortedInfo.columnKey === "count_audio" && sortedInfo.order
              : null,
            onHeaderCell: (column) => ({
              width: column.width,
              onResize: this.handleResize(index),
        ...
        case 6:
          return {
            ...col,
            sortOrder: !isEmpty(sortedInfo)
              ? sortedInfo.columnKey === "views_per_audio" && sortedInfo.order
              : null,
            onHeaderCell: (column) => ({
              width: column.width,
              onResize: this.handleResize(index),
